			...
			<div class="com_content">
				<div>
					...
					<div row>
						...
						<!-- insert form -->
						<form action="q_insert.do" id="insertform" method="post">
							<c:if test="${dto.num != null}">
								<input type="hidden" name="num" value="${dto.qna_group }" />
							</c:if>
							<div class="col-xs-4 innerdiv">
								<label for="writer">writer</label><br /> <input
									class="form-control" type="text" id="writer" name="writer" value="${id }"
									disabled="disabled" />
							</div>
							...
							<textarea name="content" id="content"
								...
								<br>
								<c:if test="${dto.num != null}">
								<c:if test="${dto.num == dto.qna_group }">
								[ original message ]
								</c:if>
								<br />		
								${dto.content}
							...
							<div class="col-xs-6 ">
								<button type="button" style="width: 40%;" onclick="submitContents(this);" value="send">send</button>
							</div>
